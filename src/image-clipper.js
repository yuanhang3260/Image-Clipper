...
$canvasClipContainer.on("mousemove", function(e) {
  e.stopPropagation();
  if (!imageLoaded) {
    return;
  }
...
$canvasClipContainer.on("mouseup", function(e) { 
  e.stopPropagation();
  mouseClicked = false;
});

$box.on("mouseup", function(e) {
  $canvasClipContainer.trigger("mouseup");
});
